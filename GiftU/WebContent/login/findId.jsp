			...
			<div class="row">
				<div class="col-lg-12">
					<div class="login_form_inner">
						<h3>아이디 찾기</h3>
						<form class="row login_form" id="findIdForm" method="post" action="${contextPath}/member/findIdPro.do">
							<div class="col-md-9 form-group">
								<input type="text" class="form-control" id="email" name="email" placeholder="가입당시 이메일을 입력해주세요" 
