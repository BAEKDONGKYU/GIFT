...
<!--================ Start Header Menu Area =================-->
	...
	<section class="section-margin--small">
		...
		<form action="${contextPath}/product/updateProComment.do?num=${comment.num}&pageNum=${pageNum}&num_c=${comment.num_c}" method="post">
			<table id="notice" align="center" border="1" style="width: 680px;  line-height: 30px;">
				<tr>
					<td>작성자</td>
					<td><input type="text" class="form-control" name="name" style="width: 335px; height: 28px;" value="${comment.name}" readonly></td>
				</tr>
				
				<tr>
					<td>글내용</td>
					<td><textarea name="content" rows="13" cols="30" style="width: 100%;" class="form-control different-control w-100">${comment.content}</textarea></td>
				</tr>
			</table>
				...
				<div id="table_search" align="right" style="width: 68%; margin-top: 20px;">
					...
					<input type="button" value="취소" class="button button--active button-contactForm" onclick="viewDetail.do?num=${comment.num}&pageNum=${pageNum}'">
