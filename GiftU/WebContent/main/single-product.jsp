          ...
          <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
            <ul class="nav navbar-nav menu_nav ml-auto mr-auto">
              ...
              <li class="nav-item submenu dropdown">
                ...
                <ul class="dropdown-menu">
                  <li class="nav-item"><a class="nav-link" href="blog/blog.jsp">Blog</a></li>
                  <li class="nav-item"><a class="nav-link" href="blog/notice.jsp">Notice</a></li>
                </ul>
							</li>
							<li class="nav-item submenu dropdown">
                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="nav-item"><a class="nav-link" href="register/register.jsp">Register</a></li>									
                  <li class="nav-item"><a class="nav-link" href="register/memberInfo.jsp">My Page</a></li>
                </ul>
              </li>
